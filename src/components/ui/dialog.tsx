...
function DialogTrigger({
  ...
  const child = render === undefined && React.isValidElement(children) ? children : undefined
  return (
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        {...props}
      >
        <div className="grid min-h-0 flex-1 gap-4 overflow-y-auto overflow-x-hidden overscroll-contain p-4">
          {children}
        </div>
        {showCloseButton && (
